 ...
 **/
public class SendTask1 implements  Runnable {
   ...
   // private final static Logger logger1 = LoggerFactory.getLogger("runReturn");
    ...
    public SendTask1(Integer number,Integer i, String[] bjslcode, String[] lszmcode){
        this.number = number;
        this.i = i;
